            ...
            <div className="about">
                <div className="container about-container">
                    <div className="about-content-holder">
                        <img className='confident-image' src={Confident} alt="A confident woman" />
                    ...
                    <div className="about-circle-container">
                        <img className='about-circle' src={AboutCircle} alt="ruby" />
                        <img src={Ruby} className='about-ruby' alt="circle illustration" />
                    </div>
                </div>
            </div>
        </div>
